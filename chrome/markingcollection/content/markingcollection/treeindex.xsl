...
<xsl:output method="html" version="4.01" encoding="UTF-8" indent="yes"/>
  ...
  <xsl:template match="OBJECT">
    <div style="float:left;padding-right:0.3em;">
      <img src="data:image/png;base64," valign="top" class="twisty" onclick="twisty(this)">
      </img>
      <a>
      ...
      <div style="display:none;">
        <table style="padding:0px;border:1px solid #fc6;border-top:1px solid #fc6;" width="100%">
          <tbody>
            <tr>
              <th style="background-color: #e6e6e6;font-size:0.9em;">URL</th>
              <td>
                <a>
                  <xsl:attribute name="href">
            ...
            <tr>
              <th style="background-color: #e6e6e6;font-size:0.9em;">NOTE</th>
